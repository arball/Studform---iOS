...
struct KlikSteel {
    ...
    mutating func calculate() throws {
        ...
        if moduleSelected.contains(Modules._1200X600_REGULAR_H_PATTERN_KLIK_STEEL) {
        ...
        if moduleSelected.contains(Modules._1200X1200_KLIK_STEEL) {
        ...
        if moduleSelected.contains(Modules._600X600_KLIK_STEEL) {
        ...
        if moduleSelected.contains(Modules._600X600_HEAVY_DUTY_KLIK_STEEL) {
