...
//  Studform
//
//  Created by iOS development on 2/10/2017.
...
struct Regal {
    ...
    mutating func calculate() throws {
        ...
        // MARK: - (Regal) - 1200 X 600 Regular H Pattern
        
        if moduleSelected.contains(Modules._1200X600_REGULAR_H_PATTERN_REGAL) {
        ...
        // MARK: - (Regal) - 1200 X 1200
        
        if moduleSelected.contains(Modules._1200X1200_REGAL) {
        ...
        // MARK: - (Regal) - 600 X 600
        
        if moduleSelected.contains(Modules._600X600_REGAL) {
        ...
        // MARK: - (Regal) - 600 X 600 Heavy
        
        if moduleSelected.contains(Modules._600X600_HEAVY_DUTY_REGAL) {
...
//
//extension Regal: CustomStringConvertible {
//
//    var description: String {
//        print("\n***Result***")
//        return "Main Tee: \(mainTee), 1200 Spacer: \(_1200_Spacer), 600 Spacer: \(_600_Spacer), hanging Rod: \(_600_Spacer), suspension Clip \(suspensionClips), anchor Chip: \(anchorClips), tile: \(tile), wall angle: \(wallAngle), C Spline: \(c_spline), T Spline: \(t_spline)"
//    }
//}
